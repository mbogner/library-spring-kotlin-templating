...
sonarqube {
    properties {
        ...
        property("sonar.projectKey", "library::spring-kotlin-templating")
        property("sonar.projectName", "spring-kotlin-templating")
...
publishing {
    ...
    publications {
        create<MavenPublication>("maven") {
            ...
            pom {
                name.set("spring-kotlin-templating")
                description.set("Templating library based on freemarker for Spring Boot.")
                ...
                scm {
                    url.set("https://github.com/mbogner/library-spring-kotlin-templating")
                    connection.set("git@github.com:mbogner/library-spring-kotlin-templating.git")
                    developerConnection.set("git@github.com:mbogner/library-spring-kotlin-templating.git")
                }
                developers {
                    developer {
                        id.set("mbo")
